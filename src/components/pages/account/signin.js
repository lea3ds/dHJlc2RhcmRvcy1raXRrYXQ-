...
class Component extends React.Component {
    ...
    confirmHandle=()=> {
        ...
        this.props.register(this.state.username, this.state.password)
            .then(() => {
                window.showDialog({title: strings.account_signin_success_title, message: strings.account_signin_success_message}, () => this.props.history.replace(routes.rootApp.path));
